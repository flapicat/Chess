...
SubTexture2D::SubTexture2D(const Ref<Texture2D>& tilemapTexture, const glm::vec2& min, const glm::vec2& max)
	:m_Texture(tilemapTexture)
{
...
Ref<SubTexture2D> SubTexture2D::CreateTextureFromCoords(const Ref<Texture2D>& texture, const glm::vec2& coords, const glm::vec2& spriteSize)
{
